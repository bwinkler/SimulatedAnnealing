...
public class Parallel2StepAnnealer extends AbstractAnnealer{

  public Parallel2StepAnnealer(  
      final int numPoints,
      final int dim,
      final double[] lb,
      final double[] ub,
        ...
        public void run() throws Exception{
          execute(0, numPoints - 1, new IntegerForLoop(){
            ...
            public void run( int first, int last ) throws Exception{
              ...
              ObjectiveFunction obj 
                = new ObjectiveFunction( xOpt, lb, ub, f );
              SimulatedAnnealer sa 
                = AnnealerFactory.getAnnealer( dim, lb, ub, xOpt, obj );
              sa.run();
              myxOpt = sa.getSolution();
              myfOpt = sa.getValue();
            }
